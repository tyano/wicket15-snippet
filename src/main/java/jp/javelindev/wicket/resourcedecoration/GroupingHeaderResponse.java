 ...
 */
package jp.javelindev.wicket.resourcedecoration;

import java.util.ArrayList;
import java.util.List;
import java.util.Set;
import jp.javelindev.wicket.resourcedecoration.GroupedAndOrderedResourceReference.ResourceGroup;
...
//		return ref.isCss() ? UNKNOWN_CSS_GROUPING_KEY : UNKNOWN_JS_GROUPING_KEY;
        return new BasicGroupingKey(ResourceGroup.PAGE, 0, ref.isCss());
	}
